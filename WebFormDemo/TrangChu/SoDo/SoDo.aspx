<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoDo.aspx.cs" Inherits="WebFormDemo.TrangChu.SoDo.SoDo" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="content">
            <div class="page">
                <h3><a href="/TrangChu/TrangChu.aspx">Trang Chủ</a> >> <a href="/TrangChu/SoDo/SoDo.aspx"> Số Đỏ </a></h3>
            </div>

            <div class="book">
                <div class="book-img">
                    <img src="/img/TrangChu/so_do.jpg" style="width:250px; height:400px; margin-top: 30px;" />
                    <br />
                ...
                <div class="book-content">
                    ...
                    <br />
                    <br />
                    <a class="btn" href="Chapter/chuong-1.aspx"> Bắt đầu đọc </a>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="chapter">
                    <li><a href="Chapter/chuong-1.aspx">Chương 1</a></li>
                    <li><a href="Chapter/chuong-2.aspx">Chương 2</a></li>
                    <li><a href="Chapter/chuong-3.aspx">Chương 3</a></li>
                    <li><a href="Chapter/chuong-4.aspx">Chương 4</a></li>
                    <li><a href="Chapter/chuong-5.aspx">Chương 5</a></li>
                    <li><a href="Chapter/chuong-6.aspx">Chương 6</a></li>
                    <li><a href="Chapter/chuong-7.aspx">Chương 7</a></li>
                </ul>
            </div>
        </div>
